            ...
            <template >
                <el-form ref="editForm" :model="editForm" label-width="80px" :rules="editFormRules">
                    ...
                    <el-form-item label="涂刷层数" prop="brushnumber">
                        <el-input  v-model="editForm.brushnumber"></el-input>
                    </el-form-item>
        ...
        >
            <template >
                <el-form ref="addForm" :model="addForm" label-width="80px" :rules="addFormRules">
                    ...
                    <el-form-item label="涂刷层数" prop="brushnumber">
                        <el-input  v-model="addForm.brushnumber" placeholder="请输入一组数字表示涂刷层数"></el-input>
                    </el-form-item>
                    <el-form-item label="产品介绍" prop="productintd">
...
<script>
    export default {
        ...
        methods: {
            fetchData() {
                this.$axios.get(this.$api.MALLSELECT,{state:2,index:this.index,page:this.page,size:this.pageSize,content:this.searchForm.content}).then(res => {
            ...
            del(id){
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.$axios.delete(this.$api.MALLDELETE,{id:id,state:2}).then(res=>{
                        if(res.data.code===200){
