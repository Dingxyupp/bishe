<template>
    <el-row>
        <el-breadcrumb separator=">" class="bread_header">
            ...
            <el-breadcrumb-item>展示区域编辑</el-breadcrumb-item>
        </el-breadcrumb>
        <el-row>
            ...
            <el-table :data="tableData" height="300" border style="width: 80%">
                ...
                >
                    <template #default="obj">
                        <el-button type="success" size="mini" @click="indexShowEdit(obj.row.id)">编辑</el-button>
...
<script>
    export default {
        ...
        methods: {
            fetchData() {
                this.$axios.get(this.$api.INDEXSHOWSELECT).then(res => {
            ...
            addUp(){
                this.$axios.post(this.$api.INDEXSHOWADD,this.addForm).then(res=>{
                    if(res.data.code===200){
            ...
            indexShowEdit(id){
                ...
                this.$axios.get(this.$api.INDEXSHOWEDIT,{id:id}).then(res => {
                    if (res.data.code === 200) {
            ...
            del(id){
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.$axios.delete(this.$api.INDEXSHOWDELETE,{id:id}).then(res=>{
                        if(res.data.code===200){
            ...
            submit(){
                ...
                this.$axios.post(this.$api.INDEXSHOWALTER,this.form).then(res => {
                    if (res.data.code === 200) {
