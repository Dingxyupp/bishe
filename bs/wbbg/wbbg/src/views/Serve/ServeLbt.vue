<template>
    <el-row>
        <el-breadcrumb separator=">" class="bread_header">
            ...
            <el-breadcrumb-item>服务页轮播图编辑</el-breadcrumb-item>
        </el-breadcrumb>
        <el-row>
            ...
            <el-table :data="tableData" height="300" border style="width: 80%">
                ...
                <el-table-column
                    ...
                    <template #default="scope">
                        <img :src="scope.row.detail" class="head_pic"/>
                    </template>
                </el-table-column>
                <el-table-column
                        prop="interview"
                ...
                >
                    <template #default="obj">
                        <el-button type="success" size="mini" @click="serveLbtEdit(obj.row.id)">编辑</el-button>
...
<script>
    export default {
        ...
        methods: {
            fetchData() {
                this.$axios.get(this.$api.SERVELBTSELECT).then(res => {
            ...
            addUp(){
                this.$axios.post(this.$api.SERVELBTADD,this.addForm).then(res=>{
                    if(res.data.code===200){
            ...
            serveLbtEdit(id){
                ...
                this.$axios.get(this.$api.SERVELBTEDIT,{id:id}).then(res => {
                    if (res.data.code === 200) {
                        this.url=res.data.data.detail;
                        this.srcList.splice(0,1,res.data.data.detail);
            ...
            del(id){
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.$axios.delete(this.$api.SERVELBTDELETE,{id:id}).then(res=>{
                        if(res.data.code===200){
            ...
            submit(){
                ...
                this.$axios.post(this.$api.SERVELBTALTER,this.form).then(res => {
                    if (res.data.code === 200) {
